...
outputDirectory = "./output"  # writing directory
...
def main():
    ...
    # make directory for running results
    ...
    for i in range(len(target_graph_list)):
        ...
        for run_count in range(1, args.rc + 1):
            write_dir = os.path.join(outputDirectory, str(run_count)) if DEBUG else outputDirectory
